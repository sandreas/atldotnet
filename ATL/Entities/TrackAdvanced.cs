...
public class TrackAdvanced
{
    ...
    public TrackAdvanced(string path, bool load = true)
    {
        this.Path = path;
        stream = null;
        if (load) Update();
    ...
    public TrackAdvanced(Stream stream, string mimeType = "")
    {
        this.stream = stream;
    ...
    private MetadataContainer DefaultMetdataContainer = new MetadataContainer();
    // private List<MetadataContainer> MetadataContainers = new();
    ...
    public string Title
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.TITLE);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.TITLE, value);
    }
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.ARTIST);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.ARTIST, value);
    }
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.COMPOSER);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.COMPOSER, value);
    }
    ...
    public string Genre
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.GENRE);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.GENRE, value);
    }
    ...
    public string Album
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.ALBUM);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.ALBUM, value);
    }
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.ORIGINAL_ALBUM);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.ORIGINAL_ALBUM, value);
    }
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.ORIGINAL_ARTIST);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.ORIGINAL_ARTIST, value);
    }
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.COPYRIGHT);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.COPYRIGHT, value);
    }

    /// <summary>
    /// General description
    /// </summary>
    public string Description { get; set; } // TODO XXX
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<string>(TagData.Field.PUBLISHER);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.PUBLISHER, value);
    }
    ...
    {
        get => DefaultMetdataContainer.GetFieldValue<DateTime?>(TagData.Field.PUBLISHING_DATE);
        set => DefaultMetdataContainer.SetFieldValue(TagData.Field.PUBLISHING_DATE, value);
    }
    ...
    public int? Year
    {
        ...
        set
        {
            if (canUseValue(value) && value.Value > DateTime.MinValue.Year)
                Date = new DateTime(value.Value, 1, 1, 0, 0, 0, DateTimeKind.Utc);
    ...
    public int? OriginalReleaseYear
    {
        ...
        {
            if (canUseValue(value) && value.Value > DateTime.MinValue.Year)
                OriginalReleaseDate = new DateTime(value.Value, 1, 1, 0, 0, 0, DateTimeKind.Utc);
    ...
    protected void Update(bool onlyReadEmbeddedPictures = false)
    {
        ...
        SupportedMetadataFormats =
            new List<Format>(fileIO.GetSupportedMetas()
                .Select(f => MetaDataIOFactory.GetInstance().getFormat((int)f)));
    ...
    internal TagData toTagData()
    {
        ...
        result.IntegrateValue(TagData.Field.TITLE, Title);
        result.IntegrateValue(TagData.Field.ARTIST, Artist);
        result.IntegrateValue(TagData.Field.COMPOSER, Composer);
        result.IntegrateValue(TagData.Field.COMMENT, Comment);
        result.IntegrateValue(TagData.Field.GENRE, Genre);
        result.IntegrateValue(TagData.Field.ORIGINAL_ARTIST, OriginalArtist);
        result.IntegrateValue(TagData.Field.ORIGINAL_ALBUM, OriginalAlbum);
        result.IntegrateValue(TagData.Field.GENERAL_DESCRIPTION, Description);
        if (Popularity.HasValue)
            result.IntegrateValue(TagData.Field.RATING, toTagValue(Popularity.Value));
        else result.IntegrateValue(TagData.Field.RATING, Settings.NullAbsentValues ? "" : "0");
        result.IntegrateValue(TagData.Field.COPYRIGHT, Copyright);
        result.IntegrateValue(TagData.Field.PUBLISHER, Publisher);
        result.IntegrateValue(TagData.Field.PUBLISHING_DATE, toTagValue(PublishingDate));
        result.IntegrateValue(TagData.Field.ALBUM_ARTIST, AlbumArtist);
        result.IntegrateValue(TagData.Field.CONDUCTOR, Conductor);
        result.IntegrateValue(TagData.Field.LYRICIST, Lyricist);
        result.IntegrateValue(TagData.Field.INVOLVED_PEOPLE, InvolvedPeople);
        result.IntegrateValue(TagData.Field.PRODUCT_ID, ProductId);
        result.IntegrateValue(TagData.Field.ISRC, ISRC);
        result.IntegrateValue(TagData.Field.CATALOG_NUMBER, CatalogNumber);
        result.IntegrateValue(TagData.Field.AUDIO_SOURCE_URL, AudioSourceUrl);
        result.IntegrateValue(TagData.Field.SORT_ALBUM, SortAlbum);
        result.IntegrateValue(TagData.Field.SORT_ALBUM_ARTIST, SortAlbumArtist);
        result.IntegrateValue(TagData.Field.SORT_ARTIST, SortArtist);
        result.IntegrateValue(TagData.Field.SORT_TITLE, SortTitle);
        result.IntegrateValue(TagData.Field.GROUP, Group);
        result.IntegrateValue(TagData.Field.SERIES_TITLE, SeriesTitle);
        result.IntegrateValue(TagData.Field.SERIES_PART, SeriesPart);
        result.IntegrateValue(TagData.Field.LONG_DESCRIPTION, LongDescription);
        result.IntegrateValue(TagData.Field.LANGUAGE, Language);
        result.IntegrateValue(TagData.Field.BPM, toTagValue(BPM));
        result.IntegrateValue(TagData.Field.ENCODED_BY, EncodedBy);
        result.IntegrateValue(TagData.Field.ENCODER, Encoder);
        if (isYearExplicit)
        {
            result.IntegrateValue(TagData.Field.RECORDING_YEAR, toTagValue(Year));
            result.IntegrateValue(TagData.Field.RECORDING_DATE, toTagValue(Year));
        }
        else
        {
            result.IntegrateValue(TagData.Field.RECORDING_DATE, toTagValue(Date));
            result.IntegrateValue(TagData.Field.RECORDING_YEAR, "");
        }

        if (isORYearExplicit)
        {
            result.IntegrateValue(TagData.Field.ORIG_RELEASE_YEAR, toTagValue(OriginalReleaseYear));
            result.IntegrateValue(TagData.Field.ORIG_RELEASE_DATE, toTagValue(OriginalReleaseYear));
        }
        else
        {
            result.IntegrateValue(TagData.Field.ORIG_RELEASE_DATE, toTagValue(OriginalReleaseDate));
            result.IntegrateValue(TagData.Field.ORIG_RELEASE_YEAR, "");
        }

        result.IntegrateValue(TagData.Field.ALBUM, Album);
        result.IntegrateValue(TagData.Field.TRACK_NUMBER, toTagValue(TrackNumber));
        result.IntegrateValue(TagData.Field.TRACK_TOTAL, toTagValue(TrackTotal));
        result.IntegrateValue(TagData.Field.DISC_NUMBER, toTagValue(DiscNumber));
        result.IntegrateValue(TagData.Field.DISC_TOTAL, toTagValue(DiscTotal));
        result.IntegrateValue(TagData.Field.CHAPTERS_TOC_DESCRIPTION, ChaptersTableDescription);
    ...
    public async Task<bool> SaveToAsync(string target, Action<float> writeProgress = null)
    {
        ...
        // Write what needs to be written
        bool result =
            await fileIO.SaveAsync(toTagData(), null, target, null, new ProgressToken<float>(writeProgress));
        // Update internal references
        if (result)
        {
            Path = target;
    ...
    public async Task<bool> SaveToAsync(Stream target, Action<float> writeProgress = null)
    {
        ...
        // Write what needs to be written
        bool result =
            await fileIO.SaveAsync(toTagData(), null, null, target, new ProgressToken<float>(writeProgress));
        // Update internal references
        if (result)
        {
            this.stream = target;
    ...
    {
        bool result =
            await fileIO.SaveAsync(toTagData(), null, null, null, new ProgressToken<float>(writeProgress));
        if (result) Update();
    ...
    {
        bool result = await fileIO.SaveAsync(toTagData(), tagType, null, null,
            new ProgressToken<float>(writeProgress));
        if (result) Update();
    ...
    public bool Remove(MetaDataIOFactory.TagType tagType = MetaDataIOFactory.TagType.ANY,
        Action<float> writeProgress = null)
    {
    ...
    public async Task<bool> RemoveAsync(MetaDataIOFactory.TagType tagType = MetaDataIOFactory.TagType.ANY,
        IProgress<float> writeProgress = null)
    {
